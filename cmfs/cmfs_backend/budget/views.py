...
DO NOT BUILD YET (Phase 5 scope): actual expense tracking, unbudgeted
expense entry, M-Pesa payment flows. `is_unbudgeted` exists on the model
for Phase 9 but is never set True from these endpoints.
"""
